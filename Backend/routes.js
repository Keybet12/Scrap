...
const { payHomeowner, getPaymentsByCollector, getPaymentsByHomeowner } = require("./controllers/paymentController");
...
router.get("/payments/collector/:collectorId", getPaymentsByCollector);
router.get("/payments/homeowner/:homeownerId", getPaymentsByHomeowner);
